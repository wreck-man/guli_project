...
import com.youxin.serviceucenter.utils.ConstantWxUtils;
import com.youxin.serviceucenter.utils.HttpClientUtils;
...
@RequestMapping("/serviceucenter/api/ucenter/wx")
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            ...
            throw new YouXinException(20001,"登录失败");
        }
    }
