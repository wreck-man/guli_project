          ...
          <section class="fl">
            <ol class="js-tap clearfix">
              <li :class="{'current bg-orange':buyCountSort!=''}">
                <a title="关注度" href="#" @click="BuyCount()">关注度</a>
              </li>
              <li :class="{'current bg-orange':gmtCreateSort!=''}">
                <a title="最新" href="#" @click="gmtNew()">最新</a>
              </li>
              <li :class="{'current bg-orange':priceSort!=''}"  @click="ByPrice()">
                <a title="价格" href="#"
                  >价格&nbsp;
                  <span>↓</span>
                </a>
              </li>
              <li :class="{'current bg-orange':priceSort!=''}" @click="BysPrice()">
                <a title="价格" href="#"
                  >价格&nbsp;
                  <span>↑</span>
                </a>
        ...
        <div>
          <div class="paging">
            ...
            <a
              ...
              href="#"
              title="前一页"
              @click.prevent="getPageList(data.current - 1)"
              >&lt;</a
            >
            <a
              ...
              :title="'第' + page + '页'"
              href="#"
              @click.prevent="getPageList(page)"
              >{{ page }}</a
            >
            <a
            ...
            <a
              ...
              href="#"
              title="末页"
              @click.prevent="getPageList(data.pages)"
              >末</a
            >
            <div class="clear" />
          </div>
...
export default {
  ...
  methods: {
    ...
    selectTwo(subjectId,index) {
      this.twoIndex=index;
      this.searchObj.subjectId = subjectId;
      this.getPageList();
    },
    selectOne(parentId, index) {
      this.searchObj.subjectId = null;
      if (parentId == null || index == null) {
        this.searchObj.subjectParentId = null;
        this.subSubjectList = [];
        this.oneIndex=-1;
        this.initCourse();
        return;
